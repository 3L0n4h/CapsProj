               ...
               /* databaseref.orderByChild("Mon").equalTo("Y").addChildEventListener(new ChildEventListener() //this works
                {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String prevChildKey) {
                        if(dataSnapshot.exists()){
                            ...
                            listAddrs.add(dataSnapshot.getKey());
                        }
                    }
                    @Override
...
*/
    ...
    public void requestDirection() {
        LatLng urLoc = new LatLng(mLastLocation.getLatitude(),
...
*/
    ...
    private double CalculateDistance(LatLng endPoint)
    {
        ...
        currLoc.setLongitude(urLoc.longitude);
        currLoc.setLatitude(urLoc.latitude);
